...
function preload() {
  ...
  manImg = loadImage("images/boy_and_bow.png")
...
function draw() {
  ...
  strokeWeight(1)
  stroke(0)
  instructionText = text("Press Space To Aim the blue target ( for 10 points ) or Aim the black target ( for 5 points ) ", 50, 30);
